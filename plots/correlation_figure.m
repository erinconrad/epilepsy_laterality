...
fprintf(fid,['We first measured inter-feature correlation on an electrode contact-level. To do '...
    ...
    'number of features times the number of references (30 x 3 = 90). Supplementary Figure 2A shows the '...
...
fprintf(fid,[' Supplementary Figure 2B shows the mean (standard deviation) inter-reference feature correlation '...
...
fprintf(fid,['<p>We repeated this inter-feature correlation analysis, this time '...
    ...
    'Supplementary Figure 2C shows the inter-feature AI correlation, again restricting analysis to common '...
    'average reference. Again, we observed high inter-feature correlation for several features. '...
    'Supplementary Figure 2D shows the inter-reference AI correlation (there are no error bars because '...
