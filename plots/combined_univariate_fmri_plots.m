...
for ig = 1:2
    ...
    if ig == 1
        fprintf(fid,['We next compared the set of features that best distinguished '...
            ...
            'Several interictal features were highly correlated (see Fig. S1 and Supplemental Results).'...
            ' We observed similar trends when we restricted analysis of unilateral patients '...
            'to those with Engel 1 surgical outcomes (Supplemental Results, Fig. S2B).</p>']);
    else
        fprintf(sfid,['We next compared the set of features that best distinguished '...
            ...
            '(and no features were significant) (Fig. S2B).</p>']);
    end
