...
for ig = 1:2
    ...
    if ig == 1
        ...
        fprintf(fid,[' We ranked '...
            ...
            'Supplementary Table 2 shows the corresponding statistics for the features '...
        ...
        fprintf(sfid,[' Again, the top-ranked AI '...
            'features involved spike rates and '...
            'relative entropy (Supplementary Figure 3A). ']);
    end
    ...
    if ig == 1
        fprintf(fid,['We next compared the set of features that best distinguished '...
            ...
            ' after correcting for the false discovery rate). Supplementary Tables 3 and 4 '...
            ...
            'entropy (see Supplementary Figure 2 and Supplementary Results).'...
            ...
            'in this smaller patient cohort (Supplementary Figure 3).</p>']);
    else
        fprintf(sfid,['We next compared the set of features that best distinguished '...
            'left from bilateral SOZs versus right from bilateral SOZs (Supplementary Figure 3B). '...
    ...
    if ig == 1
        ...
        print(gcf,[plot_folder,'Fig2'],'-depsc')
    elseif ig == 2
        annotation('textbox',[0 0.9 0.1 0.1],'String','A','LineStyle','none','fontsize',25)
        annotation('textbox',[0.5 0.9 0.1 0.1],'String','B','LineStyle','none','fontsize',25)
        %print(gcf,[plot_folder,'FigS2'],'-dpng')
    ...
    %print(gcf,[plot_folder,'Fig2'],'-dpng')
    print(fmriF,[plot_folder,'Fig3'],'-dpng')
    print(fmriF,[plot_folder,'Fig3'],'-depsc')
