...
%% Load the manual validation file containing specific localizations
sozT = readtable('Manual validation.xlsx','Sheet','SOZ');
soz_region = sozT.region;
soz_name = sozT.name;
...
for ir = 1:length(which_refs)
    ...
    for io = 1:2
        ...
        if ir == 1
            ...
            legend(l,sprintf('AUC = %1.2f',auc),'location','southeast','fontsize',20)
    ...
    if ir == 1
        fprintf(fid,[' %d of %d (%1.1f%%) patients had good one-year Engel outcomes (Engel I), '...
            'and %d of %d (%1.1f%%) had poor Engel outcomes (Engel 2+) (Fig. 5A). '...
            '%d of %d (%1.1f%%) patients had good one-year ILAE outcomes (ILAE 1-2), and '...
            '%d of %d (%1.1f%%) had poor ILAE outcomes (ILAE 3+) (Fig. 5D).'],good_bad(1,1),...
        ...
        fprintf(fid,[' The means of the numerical portions of the outcome scales were '...
            ...
            '(Fig. 5B and 5E; Engel: <i>t</i>(%d) = %1.1f, %s; ILAE: <i>t</i>(%d) = %1.1f, %s).'],...
        ...
        fprintf(fid,[' We hypothesized that patients with a good surgical outcome would have a '...
            ...
            'Engel outcomes (%1.2f (%1.2f)) (<i>t</i>(%d) = %1.1f, %s) (Fig. 5C), and '...
            'in patients with good ILAE outcomes (%1.2f (%1.2f)) than '...
            'in patients with poor ILAE outcomes (%1.2f (%1.2f)) (<i>t</i>(%d) = %1.1f, %s) (Fig. 5F). '...
            'Finally, we measured how well modeled TLE laterality predictions predicted '...
            'surgical outcome in unseen patients. We trained a logistic regression model to '...
    ...
    if ir == 1
        ...
        print(mainFig,[plot_folder,'Fig5'],'-dtiff')
