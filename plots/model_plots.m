...
for ia = 1:length(which_refs) 
    ...
    for io = 1:2
        ...
        elseif ia == 1 && io == 2
            sfname = [plot_folder,'results.html'];
            sfid = fopen(sfname,'a');
        ...
        elseif ia == 1 && io == 2
            fprintf(fid,['We again tested the ability of interictal features predict SOZ laterality in unseen patients, '...
        ...
        if ia == 1 && io == 1
            ...
            fprintf(fid,[' Results were similar when we restricted analysis of unilateral HUP patients to be those with '...
                'Engel 1 surgical outcomes to' ...
                'build and internally validate the SOZ laterality classifier (Fig. S3).</p>']);
