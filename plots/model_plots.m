...
for ia = 1:length(which_refs) 
    ...
    if ia == 1
        fprintf(fid,['We tested whether interictal features predict SOZ laterality in unseen patients. '...
            'The AUCs of the ROC of the left- and right-sided internal cross-validation models trained on all AI features were %1.2f '...
            'and %1.2f, respectively (Fig. 3A). A model '...
            'trained on only spike rates (%s reference) achieved similar AUCs (%1.2f '...
            ...
            'for the left and right models, respectively (Fig. 3C)). '],...
