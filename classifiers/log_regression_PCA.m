function trainedClassifier = log_regression_PCA(trainingData,responseName,predictorNames,isCategoricalPredictor,percExp)
...
explainedVarianceToKeepAsFraction = percExp;
